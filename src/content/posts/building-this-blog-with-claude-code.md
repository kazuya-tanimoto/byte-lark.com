...
安全のため、AIはMacのSandbox上で動かしています。変なものを壊される心配がない代わりに制限が強く、コマンド実行やファイル書き込みのたびに「やっていい？」と承認を求められて止まります。  
...
- [公式の設定例](https://code.claude.com/docs/en/devcontainer)を元に作ったコンテナ（外部との通信を遮断する仕組み入り）の中で動かす

Sandboxの設定を都度弱めていくのもなぁ。。という気がするので、devcontainerが良さそう。
これなら手元のOSと認証情報を守りつつ自走させられるっぽいので、近いうちに試したいところです。
...
- モチベーションが続く。コードを書くこと自体よりも、モノが出来上がっていく方が嬉しいタイプなので、そこが早いAIとは相性が良いです
...
置いていかれないようにキャッチアップしつつ、今後もAIでのものづくりを楽しんでいくつもりです。
